...
const PAGES = [
  ...
  { href: "/trends/by-angle", label: "Trends · Angles", icon: Hash },
  ...
  { href: "/uploads", label: "Upload ads", icon: Upload },
  { href: "/uploads/new", label: "New ad upload", icon: Upload },
  { href: "/library?tab=products", label: "Library · Products", icon: Package },
  { href: "/library?tab=angles", label: "Library · Angles", icon: Hash },
  { href: "/uploads?tab=mapping", label: "Upload ads · CSV mapping", icon: Settings },
